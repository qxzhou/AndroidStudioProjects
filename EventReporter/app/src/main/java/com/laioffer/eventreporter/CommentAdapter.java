...
public class CommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
    ...
    private void configureCommentView(CommentViewHolder viewHolder, int position) {
        int pos = position - 1;
        Comment comment = commentList.get(pos);
        viewHolder.commentUser.setText(comment.getCommenter());
        viewHolder.commentDescription.setText(comment.getDescription());
        viewHolder.commentTime.setText(Utils.timeTransformer(comment.getTime()));
    }
